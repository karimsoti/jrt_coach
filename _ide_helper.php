 ...
 * Generated for Laravel 5.6.12 on 2018-03-20 00:55:40.
 *
...
namespace Adldap\Laravel\Facades { 
    ...
    class Adldap {
         ...
         * @static 
         */ 
        public static function addProvider($config = array(), $name = 'default', $connection = null, $schema = null)
        {
            return \Adldap\Adldap::addProvider($config, $name, $connection, $schema);
        }
